...
<div align="center" style="font-family: 'Inter', 'Segoe UI', sans-serif; padding: 60px 20px; line-height: 1.6; max-width: 800px; margin: 0 auto; color: #1e293b;">

  <div style="margin-top: 60px;">
    <h3 style="text-transform: uppercase; letter-spacing: 0.15em; color: #64748b; font-weight: 600; margin-bottom: 10px;">STANDARD TEMPLATE</h3>
    <h1 style="font-size: 32px; font-weight: 800; color: #0f172a; margin-top: 10px; margin-bottom: 20px; border-bottom: 4px solid #3b82f6; padding-bottom: 15px; display: inline-block;">FREELANCER MARKETING SERVICES AGREEMENT</h1>
    <p style="font-size: 18px; color: #475569; max-width: 600px; margin: 20px auto 40px auto; font-weight: 400;">
      A legal and operational framework for freelance marketing, outbound outreach, and lead generation services.
    </p>
  </div>

  <div style="margin: 80px 0; background-color: #f8fafc; border-radius: 12px; padding: 30px; text-align: left; border: 1px solid #e2e8f0;">
    <h2 style="font-size: 18px; font-weight: 700; color: #0f172a; border-bottom: 1px solid #cbd5e1; padding-bottom: 8px; margin-bottom: 16px;">AGREEMENT PARTIES</h2>
    <table style="width: 100%; border-collapse: collapse;">
      ...
      <tr>
        <td style="font-weight: 600; color: #64748b; padding: 6px 0; vertical-align: top; border: none;">FREELANCER:</td>
        <td style="color: #334155; padding: 6px 0; font-weight: 500; border: none;">
          <strong>[Freelancer Full Name]</strong><br>
          [Address]<br>
          [Email] | [Phone Number]
        </td>
      </tr>
      <tr>
        <td style="font-weight: 600; color: #64748b; padding: 6px 0; vertical-align: top; border: none;">EFFECTIVE DATE:</td>
        <td style="color: #334155; padding: 6px 0; font-weight: 500; border: none;">[Effective Date / Start Date]</td>
      </tr>
    </table>
  </div>
...
# FREELANCER MARKETING SERVICES AGREEMENT

This Freelancer Marketing Services Agreement (hereinafter referred to as the **"Agreement"**) is entered into on this _______ day of ____________, 202___ (hereinafter referred to as the **"Effective Date"**) at Bengaluru, Karnataka, India.
...
**WHEREAS** the Client is engaged in the business of building custom internal tools, software dashboards, workflow automation systems, and providing custom IT solutions to operations-heavy businesses.

**WHEREAS** the Freelancer represents that they have the requisite expertise, qualification, skills, and resources to perform marketing services, lead generation, and social media management campaigns.

**WHEREAS** the Client desires to retain the Freelancer, and the Freelancer agrees to perform the marketing and lead generation services under the terms and conditions set forth in this Agreement.
...
1.1 **Services**: The Freelancer agrees to perform marketing services for the Client in a professional and timely manner. The services shall include, but are not limited to, the following (collectively, the **"Services"**):
* **Email Marketing Campaigns**: Drafting, managing, and sending cold and warm email sequences targeting prospective clients.
* **LinkedIn Outreach & Lead Generation**: Searching, connecting with, and messaging key decision-makers on LinkedIn to generate qualified leads.
* **Social Media Marketing**: Managing, posting, and optimizing social media channels (e.g., LinkedIn, Twitter) for brand awareness.
* **Content Creation**: Creating copy, design drafts, and articles for marketing purposes.
* **Prospect Research & Lead Qualification**: Identifying potential operations-heavy companies, researching decision-maker contact details, and qualifying prospective client lists.
* **Reporting & Analytics**: Submitting weekly reports detailing outreach metrics, response rates, leads generated, and campaign analytics.
* **Other Marketing Activities**: Any other marketing campaigns or activities mutually agreed upon in writing by the Parties.
...
2.1 **Nature of Relationship**: The relationship between the Client and the Freelancer is strictly that of an **independent contractor**. Nothing contained in this Agreement shall be construed to create a partnership, joint venture, employer-employee, agency, or franchise relationship between the Parties.

2.2 **No Employment Benefits**: The Freelancer is not entitled to any benefits, perks, insurance coverages, provident fund contributions, gratuity, paid leave, bonus, or other statutory benefits available to the employees of the Client.

2.3 **Method of Execution**: The Freelancer shall determine the method, details, and means of performing the Services, subject to the final guidelines and expectations of the Client. The Client shall not exercise direct control over the Freelancer’s working hours or physical work location.

---

## 3. TERM & TERMINATION

3.1 **Term**: This Agreement shall commence on **[Start Date]** and shall continue in full force and effect until terminated by either Party in accordance with Section 3.2 or 3.3.

3.2 **Termination for Convenience**: Either Party may terminate this Agreement at any time, without assigning any reason, by giving **7 (seven) days' prior written notice** (including email) to the other Party.

3.3 **Immediate Termination for Cause**: The Client reserves the right to terminate this Agreement immediately, without prior notice and without any liability to pay compensation, in the event that the Freelancer:
* Commits a breach of any Confidentiality, Non-Disclosure, or Data Security obligations.
* Engages in any unauthorized access, sharing, or tampering of the Client's databases, credentials, or systems.
* Commits any fraud, gross negligence, willful misconduct, or illegal activity under Indian law.
* Repeatedly fails to deliver the Services to the reasonable satisfaction of the Client after receiving a written warning.
* Acts in a manner that damages the reputation, goodwill, or business interests of the Client.
...
* The Freelancer shall submit invoices to the Client on a [Weekly/Monthly] basis.
* Approved invoices shall be paid within **___ days** of receipt by the Client via bank transfer or online payment mode.
...
5.1 **Confidential Information**: The Freelancer acknowledges that during the course of the engagement, they will have access to proprietary, sensitive, and confidential information belonging to the Client (collectively, **"Confidential Information"**). This includes, but is not limited to:
* Customer information, client lists, and contact data.
* Lead databases, qualified prospects, outreach databases, and templates.
...
* Not disclose, share, distribute, publish, or copy any Confidential Information to any third party without the express prior written consent of the Client.
* Use the Confidential Information solely for the purpose of executing the Services under this Agreement and for no other purpose.
* Apply strict security measures to prevent unauthorized disclosure, leakage, or loss of the Confidential Information.

5.3 **Exceptions**: The confidentiality obligation does not apply to information that:
* Is or becomes publicly known through no breach or fault of the Freelancer.
* Is lawfully acquired from a third party without restrictions on disclosure.
* Is required to be disclosed by law or court order, provided the Freelancer gives immediate written notice to the Client to allow the Client to seek a protective order.

5.4 **Survival**: The obligations of confidentiality under this Section 5 shall survive the termination of this Agreement for a period of **3 (three) years** from the date of termination.
...
6.3 **Third-Party Rights**: The Freelancer warrants that all Work Product delivered to the Client is original and does not infringe upon any copyright, trademark, patent, trade secret, or other proprietary rights of any third party.
...
* Not share passwords, multi-factor codes, or login details with any third party.
* Not grant any third-party access to the Client's systems or files without prior written approval.
* Not download, extract, or export databases to personal drives or local storage unless explicitly authorized.

7.3 **Incident Reporting**: The Freelancer shall immediately notify the Client in writing (within 12 hours) if they suspect any unauthorized access, password compromise, malware infection, data breach, or security incident involving the Client's systems or accounts.

7.4 **Revocation of Access**: Upon termination of the Agreement, all Access Credentials will be immediately revoked by the Client, and the Freelancer shall cease all attempts to log in to any Client accounts.
...
## 9. PERFORMANCE EXPECTATIONS AND COMPLIANCE
...
10.1 **Obligation to Return**: Immediately upon the termination of this Agreement, or at any time upon the written request of the Client, the Freelancer shall:
* Return to the Client all physical property, documents, devices, and files belonging to the Client.
* Hand over all campaign drafts, reports, lead databases, and templates created.
* Cease using all Access Credentials.
* Permanently delete all copies of Client documents, databases, customer files, email logs, and internal templates stored on the Freelancer's personal computer, cloud drives, mobile devices, or email accounts, and provide a written certification to the Client confirming such deletion.
...
11.2 **Limitation of Liability**: In no event shall the Client be liable for any indirect, incidental, special, or consequential damages, or loss of profits arising out of this Agreement. The Client's total liability under this Agreement shall be limited to the amount of unpaid Fees due to the Freelancer.

---

## 12. LIMITATION OF AUTHORITY & SYSTEM RESTRICTIONS

12.1 **System Restrictions**: The Freelancer shall not attempt to access, modify, or obtain credentials for any of the Client's:
* Banking portals, corporate credit cards, or financial accounts.
* Domain registrars (e.g., Hostinger, Cloudflare) or primary DNS records.
* Web hosting environments, Vercel deployments, or Supabase backend databases.
* Payment gateways, billing software, or official corporate tax portals.

12.2 **No Contracting Power**: The Freelancer has no authority to sign, execute, or execute any document or contract on behalf of the Client. Any contract signed by the Freelancer purporting to bind the Client shall be void and shall constitute a material breach of this Agreement.

---

## 13. GOVERNING LAW AND JURISDICTION

13.1 **Governing Law**: This Agreement and all disputes, claims, or actions arising out of it shall be governed by, interpreted, and construed in accordance with the laws of **India**.

13.2 **Jurisdiction**: The Parties agree that the courts in **Bengaluru, Karnataka** shall have exclusive jurisdiction to settle any disputes, claims, or legal actions arising under or in connection with this Agreement.

---

## 14. MISCELLANEOUS PROVISIONS

14.1 **Entire Agreement**: This Agreement constitutes the entire understanding between the Parties regarding the subject matter and supersedes all prior agreements, oral discussions, negotiations, and representations.

14.2 **Amendments**: No amendment, modification, or waiver of any provision of this Agreement shall be valid unless executed in writing and signed by both Parties.

14.3 **Severability**: If any provision of this Agreement is held to be invalid, illegal, or unenforceable by a court of law, the remaining provisions shall continue in full force and effect.

14.4 **Assignment**: The Freelancer shall not assign, delegate, or subcontract their rights or obligations under this Agreement to any third party without the express prior written consent of the Client.
...
<table class="signature-table" style="width: 100%; border: none;">
  <tr>
    ...
    <td style="width: 50%; border: none;">
      ...
      Title: <strong>Freelancer</strong><br>
      Date: ____________________________
    </td>
  </tr>
</table>
...
## ONE-PAGE SUMMARY OF KEY OBLIGATIONS (SCHEDULE A)

*This Summary Sheet forms an integral part of the Freelancer Agreement. It highlights critical operational and security duties of the Freelancer. Refer to the corresponding Agreement sections for full details.*

### 1. Scope of Marketing Actions (Section 1 & 12)
* **What you CAN do**: Draft/send marketing emails, conduct LinkedIn outreach, qualify leads, perform research, post on social media, and write marketing content.
* **What you CANNOT do**: Sign contracts, commit Client funds, negotiate product pricing, offer custom discounts, represent the business in legal agreements, or access corporate banking/hosting setups.

### 2. Confidentiality & Surviving Covenants (Section 5)
* Keep all lead databases, client lists, email logs, pricing sheets, and internal messages strictly confidential.
...
* Do not share any login details, passwords, or CRM access credentials with third parties.
* Report any security breach or credential leakage immediately.
* Do not log in to unauthorized servers, domain managers (Cloudflare/Hostinger), Vercel deployments, or financial accounts.

### 6. Termination Notice (Section 3 & 10)
* Either party can terminate this agreement for convenience with **7 days' written notice**.
* Immediate termination applies for security/data breaches, fraud, or failure to perform.
* Upon termination, you must return or permanently delete all company data on personal devices and certify in writing that this delete is complete.
...
# ACCOUNT & ACCESS GRANTED CHECKLIST (SCHEDULE B)
...
### Verification of Access Grant & Revocation:

**Initial Access Grant Acknowledgment**:
I, _______________________________ (Freelancer), acknowledge that I have received access to the checked accounts above solely for the performance of my duties. I agree to keep these login details secure and strictly comply with the security policies outlined in Section 7.
...
**Freelancer Signature**: ______________________________________

**Full Name**: ________________________________________________

**Aadhaar/Identity Number**: __________________________________
