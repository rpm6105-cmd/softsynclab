...
<section class="page-content" style="padding-top: 2rem;">
    <div class="container">
        ...
        <div class="detail-card">
            ...
            <div class="team-grid">
                <div class="team-card">
                    <img src="./assets/images/rohith-photo.jpg" alt="Rohith P M" width="180" height="180" style="width:180px; height:180px;">
                    <h3 style="font-family:'Outfit',sans-serif; margin-bottom:0.25rem;">Rohith P M</h3>
                    <p style="color:var(--accent); font-size:0.85rem; font-weight:700; text-transform:uppercase; letter-spacing:0.5px; margin-bottom:1rem;">Founder & Director</p>
                    <p style="font-size:0.88rem; color:var(--text-dim); line-height:1.6;">Technical architect coordinating systems integration, database designs, and operations audits for SME clients.</p>
                </div>
                <div class="team-card">
                    <img src="./assets/images/usman-photo.jpg" alt="Usman Begawala" width="180" height="180" style="width:180px; height:180px;">
                    <h3 style="font-family:'Outfit',sans-serif; margin-bottom:0.25rem;">Usman Begawala</h3>
                    <p style="color:var(--accent); font-size:0.85rem; font-weight:700; text-transform:uppercase; letter-spacing:0.5px; margin-bottom:1rem;">Technical Lead</p>
                    <p style="font-size:0.88rem; color:var(--text-dim); line-height:1.6;">Lead software engineer driving core code builds, API bridges, UI layout performance, and direct post-launch support.</p>
                </div>
            </div>
        </div>
